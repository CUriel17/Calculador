...
function am3(f,q,r,e,o,a){
    ...
    while(--a>=0){
        ...
        o=(d>>28)+(b>>14)+p*g;r[e++]=d&268435455
    }
    return o
}
...
BigInteger.prototype.F2=2*dbits-BI_FP;var BI_RM="0123456789abcdefghijklmnopqrstuvwxyz";
var BI_RC=new Array();
...
function bnNegate(){
    var a=nbi();BigInteger.ZERO.subTo(this,a);
    return a
}
function bnAbs(){
...
function bnpSquareTo(d){
    var a=this.abs();var b=d.t=2*a.t;
    while(--b>=0){
        d[b]=0
    }
    for(b=0;b<a.t-1;++b){
...
function bnpDivRemTo(n,h,g){
    ...
    var u=g.t,s=u-p,f=(h==null)?nbi():h;d.dlShiftTo(s,f);
    if(g.compareTo(f)>=0){
        g[g.t++]=1;
        g.subTo(f,g)
    }
    BigInteger.ONE.dlShiftTo(p,f);f.subTo(d,d);
    while(d.t<p){
        d[d.t++]=0
    }
    while(--s>=0){
